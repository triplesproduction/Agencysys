...
const STATUS_CONFIG: Record<string, { color: string; bg: string; border: string; icon: typeof Clock }> = {
    ...
    APPROVED: { color: '#10B981', bg: 'rgba(16,185,129,0.1)', border: 'rgba(16,185,129,0.25)', icon: CheckCircle },
        ...
        <div className="leaves-page fade-in" style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <GlassCard style={{ padding: '28px' }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ display: 'flex', gap: '14px', marginBottom: '16px' }}>
                        <div style={{ flex: 1 }}>
                            ...
                            <Input
                                ...
                                ref={startDateRef}
                                icon={Calendar}
                                onIconClick={() => openDatePicker(startDateRef)}
                            />
                        </div>
                        <div style={{ flex: 1 }}>
                            ...
                            <Input
                                ...
                                ref={endDateRef}
                                icon={Calendar}
                                onIconClick={() => openDatePicker(endDateRef)}
                            />
                        </div>
                    </div>
                    ...
                    {success && (
                        <div style={{ marginBottom: '14px', padding: '10px 14px', background: 'rgba(16,185,129,0.08)', color: '#10B981', borderRadius: 'var(--radius-sm)', fontSize: '0.85rem', border: '1px solid rgba(16,185,129,0.15)' }}>
