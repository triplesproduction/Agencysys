...
const getCompletedItems = (report: EODSubmissionDTO): string[] => {
    return safeParseArray(report.tasksCompleted);
};

const getInProgressItems = (report: EODSubmissionDTO): string[] => {
    return safeParseArray(report.tasksInProgress);
};
                                                        ...
                                                        <div>
                                                            ...
                                                            <div style={{ fontSize: '0.9rem', color: 'white', fontWeight: 700 }}>
                                                                {(() => {
                                                                    ...
                                                                    const hours = report.workHours || matchingLog?.hoursLogged || matchingLog?.hours_logged;
                                                                    return hours || '0.0';
                                                                })()}h
                                                            </div>
                                                        </div>
